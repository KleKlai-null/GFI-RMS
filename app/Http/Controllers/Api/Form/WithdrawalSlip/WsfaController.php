...
class WsfaController extends ApiController
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            // $data = cache()->remember('wsfa-data', 60*60*24, function() {
            //     return Wsfa::GetData()->get();
            // });

            $data = Wsfa::GetData()->get();
    ...
    public function store(WsfaRequest $request)
    {
        try {
            ...
            DocumentService::generatePDF($data, 'fa'); //Generate PDF for Backup
