...
class WsdmController extends ApiController
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            // $data = cache()->remember('wsdm-data', 60*60*24, function() {
            //     return Wsdm::GetData()->get();
            // });

            $data = Wsdm::GetData()->get();
    ...
    public function store(WsdmRequest $request)
    {
        ...
        try {
            ...
            DocumentService::generatePDF($data, 'dm'); //Generate PDF for Backup
