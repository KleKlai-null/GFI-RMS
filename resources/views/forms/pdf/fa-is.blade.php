...
<body >
    ...
    <div id="page-wrap">
        ...
        <h3 id="textCenter">Fixed Asset Information Sheet</h3>
        ...
        <div class="row">
            <div class="column">
                ...
                <div class="checkboxes">
                    <label><input type="checkbox" {{ ($data->item_type_fix_asset) ? 'checked' : '' }}> <span style="font-size:10px">Fixed Asset</span></label>
                </div>
            </div>
            <div class="column">
                <div class="borderless"><h6>Item Class</h6></div>
                    <div class="checkboxes">
                        <label><input type="checkbox" {{ ($data->item_class_sales_item) ? 'checked' : '' }}> <span style="font-size:10px">Sales Item</span></label>
                    </div>
            </div>
            <div class="column">
                <div class="borderless"><h6>Item Group</h6></div>
                    <div class="checkboxes">
                        <label><input type="checkbox" {{ ($data->item_group_fixed_asset) ? 'checked' : '' }}> <span style="font-size:10px">Fixed Asset</span></label>
                    </div>
            </div>
        </div>
        <div style="clear:both"></div>
        ...
        <div class="row">
            <div class="column">
                ...
                <div class="checkboxes">
                    <label><span style="font-size:10px">{{$data->item_details_brand}}</span></label>
                </div>
                <div class="borderless"><h6>UOM Group</h6></div>
                <div class="checkboxes">
                    <label><span style="font-size:10px">{{$data->item_details_uom_group}}</span></label>
                </div>
            </div>
            <div class="column">
                <div class="borderless"><h6>Model/Specification</h6></div>
                <div class="checkboxes">
                    <label><span style="font-size:10px">{{$data->item_details_model}}</span></label>
                </div>
                <div class="borderless"><h6>Barcode</h6></div>
                <div class="checkboxes">
                    <label><span style="font-size:10px">{{$data->item_details_barcode}}</span></label>
                </div>
            </div>
            <div class="column">
                <div class="borderless"><h6>Generic Description</h6></div>
                <div class="checkboxes">
                    <label><span style="font-size:10px">{{$data->item_details_generic_description}}</span></label>
                </div>
                <div class="borderless"><h6>Country of Origin</h6></div>
                <div class="checkboxes">
                    <label><span style="font-size:10px">{{$data->item_details_country}}</span></label>
                </div>
            </div>
            <div class="column">
                <div class="borderless"><h6>Manufacturer</h6></div>
                <div class="checkboxes">
                    <label><span style="font-size:10px">{{$data->item_details_manufacturer}}</span></label>
                </div>
        ...
        <div style="clear:both"></div>
        <h5 style="text-align: left">Inventory Data</h5>
        <div class="row">
            <div class="column">
                <div class="borderless"><h6>Set G/L Accounts by</h6></div>
                <div class="checkboxes">
                    <label><input type="checkbox" {{ ($data->sales_uom_warehouse) ? 'checked' : '' }}> <span style="font-size:10px">Warehouse</span></label><br/>
                    <label><input type="checkbox" {{ ($data->sales_uom_item_group) ? 'checked' : '' }}> <span style="font-size:10px">Item Group</span></label><br/>
                    <label><input type="checkbox" {{ ($data->sales_uom_item_level) ? 'checked' : '' }}> <span style="font-size:10px">Item Level</span></label>
                </div>
            </div>
            <div class="column">
            ...
            <div class="column">
                ...
                <div class="checkboxes">
                    <label><span style="font-size:10px">UoM</span><span style="font-size:8px"><input type="text" class="inp" value="{{$data->inventory_level_uom}}"></span></label>
        ...
        <br/>
        <div style="clear:both"></div>
        <h5 style="text-align: left" id="textLeft">Fixed Asset</h5>
        <div class="row">
            <div class="column">
                <div class="borderless"><h6>Asset Class</h6></div>
                <div class="checkboxes">
                    <label><span style="font-size:10px">{{$data->fixed_data_asset_class}}</span></label>
                </div>
                <div class="borderless"><h6>Asset Group</h6></div>
                <div class="checkboxes">
                    <label><span style="font-size:10px">{{$data->fixed_data_asset_group}}</span></label>
                </div>
                <div class="borderless"><h6>Capitalization Date</h6></div>
                <div class="checkboxes">
                    <label><span style="font-size:10px">{{$data->fixed_data_capitalization_date}}</span></label>
                </div>
            </div>
            <div class="column">
                <div class="borderless"><h6>Inventory No.</h6></div>
                <div class="checkboxes">
                    <label><span style="font-size:10px">{{$data->fixed_data_inventory_no}}</span></label>
                </div>
                <div class="borderless"><h6>Serial No.</h6></div>
                <div class="checkboxes">
                    <label><span style="font-size:10px">{{$data->fixed_data_serial_no}}</span></label>
                </div>
            </div>
            <div class="column">
                <div class="borderless"><h6>Technician</h6></div>
                <div class="checkboxes">
                    <label><span style="font-size:10px">{{$data->fixed_data_technician}}</span></label>
                </div>
                <div class="borderless"><h6>Employee</h6></div>
                <div class="checkboxes">
                    <label><span style="font-size:10px">{{$data->fixed_data_employee}}</span></label>
                </div>
            </div>
            <div class="column">
                <div class="borderless"><h6>Depreciation Group</h6></div>
                <div class="checkboxes">
                    <label><span style="font-size:10px">{{$data->fixed_data_depreciation_group}}</span></label>
                </div>
                <div class="borderless"><h6>Location</h6></div>
                <div class="checkboxes">
                    <label><span style="font-size:10px">{{$data->fixed_data_location}}</span></label>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="meta1">
                <div class="column1"><div class="borderless"><p style="font-size:8px">1.  Operations</p></div>
                    <div class="column6">
                        <label><span style="font-size:8px"><input class="inp" type="text" value="{{$data->approvalrouting->property_custodian_SOPN}}"/></span></label>
                        <label><p style="text-align: center; font-size:6px">Signature Over Printed Name</p></label>
                    </div>
    
                    <div class="column7">
                        <label><span style="font-size:8px"><input class="inp" type="text" value="{{$data->approvalrouting->property_custodian_date}}"/></span></label>
                        <label><p style="text-align: center; font-size:6px">Date</p></label>
                    </div>
    
                    <div class="column4"><label><h6>Status</h6>
                        <input type="checkbox" {{ ($data->approvalrouting->property_custodian_status === 'Passed') ? 'checked' : '' }}> <span style="font-size:8px">Passed</span><br/>
                        <input type="checkbox" {{ ($data->approvalrouting->property_custodian_status === 'Rejected') ? 'checked' : '' }}> <span style="font-size:8px">Rejected</span>
                    </label></div>
                </div>
            </div>
            <div class="meta2">
        ...
        <div class="row">
            <div class="meta1">
                <div class="column1"><div class="borderless"><p style="font-size:8px">2. General Manager</p></div>
                    <div class="column6">
                        <label><span style="font-size:8px"><input class="inp" type="text" value="{{$data->approvalrouting->general_manager_SOPN}}"/></span></label>
                        <label><p style="text-align: center; font-size:6px">Signature Over Printed Name</p></label>
                    </div>
    
                    <div class="column7">
                        <label><span style="font-size:8px"><input class="inp" type="text" value="{{$data->approvalrouting->general_manager_date}}"/></span></label>
                        <label><p style="text-align: center; font-size:6px">Date</p></label>
                    </div>
    
                    <div class="column4"><label><h6>Status</h6>
                        <input type="checkbox" {{ ($data->approvalrouting->general_manager_status === 'Passed') ? 'checked' : '' }}> <span style="font-size:8px">Passed</span><br/>
                        <input type="checkbox" {{ ($data->approvalrouting->general_manager_status === 'Rejected') ? 'checked' : '' }}> <span style="font-size:8px">Rejected</span>
                    </label></div>
                </div>
            </div>
            <div class="meta2">
