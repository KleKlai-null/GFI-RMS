            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">   
                    <div class="btn-list">
                        ...
                        <x-form-index-credit-memo new="{{ route('fg.create-credit-memo') }}" permission="create cm"/>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <table class="table" style="min-height: 350px">
                                        ...
                                        <tbody class="table-tbody">
                                                            ...
                                                            <div class="btn-list btn-ghost-primary flex-nowrap">
                                                              <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end" style="">
                                                                  <a class="dropdown-item" href="{{ route('fg.show', $data->id) }}">
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="7">
                                                        <x-form-index-search-empty route="{{ route('fg.create-credit-memo') }}" buttonText="Add finished goods record" permission="create cm"/>
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                                ...
                                <div class="container-xl d-flex flex-column justify-content-center">
                                    <div class="empty">
                                        ...
                                        <div class="empty-action">
                                            <a href="{{ route('fg.create-credit-memo') }}" class="btn btn-primary">
