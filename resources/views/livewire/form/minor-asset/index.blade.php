            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">   
                    <div class="btn-list">
                        ...
                        <x-form-index-header new="{{ route('ma.create') }}" permission="create ma" creditMemo="{{ route('ma.create-credit-memo') }}" />
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <table class="table card-table table-vcenter text-nowrap datatable">
                                        ...
                                        <tbody class="table-tbody">
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="7">
                                                        <x-form-index-search-empty route="{{ route('ma.create') }}" buttonText="Add minor asset record" permission="create ma"/>
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                                ...
                                <div class="container-xl d-flex flex-column justify-content-center">
                                    <div class="empty">
                                        ...
                                        <div class="empty-action">
                                            <a href="{{ route('ma.create') }}" class="btn btn-primary">
