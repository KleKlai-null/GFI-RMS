            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        ...
                        <x-form-index-header new="{{ route('mi.create') }}" permission="create mi" creditMemo="{{ route('mi.create-credit-memo') }}" />
                    </div>
                </div>
            </div>
        </div>
                                                ...
                                                <tr>
                                                    <td colspan="7">
                                                        <x-form-index-search-empty route="{{ route('mi.create') }}"
                                                            buttonText="Add merchandise record" permission="create mi" />
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
