            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        ...
                        <x-form-index-credit-memo new="{{ route('dm.create-credit-memo') }}" permission="create cm" />
                    </div>
                </div>
            </div>
        </div>
                                                ...
                                                <tr>
                                                    <td colspan="7">
                                                        <x-form-index-search-empty
                                                            route="{{ route('dm.create-credit-memo') }}"
                                                            buttonText="Add direct material record"
                                ...
                                <div class="container-xl d-flex flex-column justify-content-center">
                                    <div class="empty">
                                        ...
                                        <div class="empty-action">
                                            <a href="{{ route('dm.create-credit-memo') }}" class="btn btn-primary">
