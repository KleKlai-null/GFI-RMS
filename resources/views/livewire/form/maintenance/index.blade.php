            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">   
                    <div class="btn-list">
                        ...
                        <x-form-index-header new="{{ route('mro.create') }}" permission="create mro" creditMemo="{{ route('mro.create-credit-memo') }}" />
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <table class="table" style="min-height: 350px">
                                        <thead>
                                            <tr>
                                                <th><button class="table-sort" data-sort="sort-series">Document Series
                                                        No</button></th>
                                                <th><button class="table-sort" data-sort="sort-type">Profit
                                                        Center</button></th>
                                        ...
                                        <tbody class="table-tbody">
                                            @forelse($datas as $data)
                                                <tr>
                                                    <a href="google.com">
                                                        ...
                                                        <td class="sort-city">{{ ucwords($data->profit_center) }}</td>
                                                            ...
                                                            <div class="btn-list btn-ghost-primary flex-nowrap">
                                                              <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end" style="">
                                                                  <a class="dropdown-item" href="{{ route('mro.show', $data->id) }}">
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="7">
                                                        <x-form-index-search-empty route="{{ route('mro.create') }}" buttonText="Add maintenance, repairs and operations record" permission="create mro"/>
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                                ...
                                <div class="container-xl d-flex flex-column justify-content-center">
                                    <div class="empty">
                                        ...
                                        <p class="empty-subtitle text-muted">
                                            ...
                                            maintenance, repairs and operations record
                                        </p>
                                        <div class="empty-action">
                                            <a href="{{ route('mro.create') }}" class="btn btn-primary">
                                                ...
                                                Add maintenance, repairs and operations record
                                            </a>
                                        </div>
                                    </div>
                                </div>
