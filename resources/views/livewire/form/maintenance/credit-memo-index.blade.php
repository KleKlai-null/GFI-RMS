            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        ...
                        <x-form-index-credit-memo new="{{ route('mro.create-credit-memo') }}" permission="create cm" />
                    </div>
                </div>
            </div>
        </div>
                                            ...
                                            @forelse($datas as $data)
                                                <tr>
                                                    <a href="google.com">
                                                        ...
                                                        <td class="sort-progress">{{ $data->current_department ?? '-' }}
                                                        </td>
                                                        <td>
                                                ...
                                                <tr>
                                                    <td colspan="7">
                                                        <x-form-index-search-empty
                                                            route="{{ route('mro.create-credit-memo') }}"
                                                            buttonText="Add maintenance, repairs and operations record"
                                                            permission="create cm" />
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                                ...
                                <div class="container-xl d-flex flex-column justify-content-center">
                                    <div class="empty">
                                        ...
                                        <div class="empty-action">
                                            <a href="{{ route('mro.create-credit-memo') }}" class="btn btn-primary">
