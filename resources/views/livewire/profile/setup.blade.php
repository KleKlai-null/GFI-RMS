                ...
                <div class="card-body">
                    ...
                    {{-- <div>
                        ...
                        <select class="form-select mb-0">
                            ...
                            <option value="CEDT">(UTC+01:00) Belgrade, Bratislava, Budapest, Ljubljana,
                                Prague</option>
                            ...
                            <option value="MPST" selected>(UTC+08:00) Kuala Lumpur, Singapore</option>
            ...
            <div class="row align-items-center mt-3">
                <div class="col-4">
                    <div class="progress">
                        <div class="progress-bar" style="width: 90%" role="progressbar" aria-valuenow="90"
                            aria-valuemin="0" aria-valuemax="100" aria-label="90% Complete">
                ...
                <div class="col">
                    <div class="btn-list justify-content-end">
                        <a wire:click="skip_setup" class="btn btn-link link-secondary">
                            Set up later
                        </a>
